...
import { ProductPerformance, formatCurrency } from "@/lib/data/analytics";
        ...
        {products.map((product, index) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-[#6F7285]">{product.sku}</p>
            </div>
            ...
            <div className="text-right">
              <p className={`text-sm font-semibold tabular-nums ${
                ...
                {type === "top" ? formatCurrency(product.revenue) : `${product.unitsSold} sold`}
              </p>
              {type === "top" ? (
                <p className="text-xs text-[#6F7285] tabular-nums">{product.unitsSold} units</p>
              ) : product.stockAge ? (
